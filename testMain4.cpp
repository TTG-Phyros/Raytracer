...
int main()
{
    ...
    // Check for intersection with the sphere for each ray
    int hits = 0;
    ...
    // Output the number of rays that hit the sphere
    std::cout << "Number of rays hitting the sphere: " << hits << std::endl;
