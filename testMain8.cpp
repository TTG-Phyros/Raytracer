...
int main()
{
    ...
    // Debug output for sphere parameters
    std::cout << "Sphere Center: (" << sphere.center.x << ", " << sphere.center.y << ", " << sphere.center.z << "), Radius: " << sphere.radius << std::endl;
    ...
    for (const Ray &ray : rays) {
        // Debug output for ray parameters
        std::cout << "Ray Origin: (" << ray.origin.x << ", " << ray.origin.y << ", " << ray.origin.z << "), Direction: (" << ray.direction.x << ", " << ray.direction.y << ", " << ray.direction.z << ")" << std::endl;
